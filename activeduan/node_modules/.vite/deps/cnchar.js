...
// node_modules/cnchar/cnchar.min.js
var require_cnchar_min = __commonJS({
  "node_modules/cnchar/cnchar.min.js"(exports, module) {
    !function(n, e) {
      ...
      return function(n) {
        ...
        function r(o) {
          if (e[o])
            return e[o].exports;
          var t = e[o] = { i: o, l: false, exports: {} };
          return n[o].call(t.exports, t, t.exports, r), t.l = true, t.exports;
        }
        return r.m = n, r.c = e, r.d = function(n2, e2, o) {
          r.o(n2, e2) || Object.defineProperty(n2, e2, { enumerable: true, get: o });
        }, r.r = function(n2) {
          ...
          if (1 & e2 && (n2 = r(n2)), 8 & e2)
            return n2;
          if (4 & e2 && "object" == typeof n2 && n2 && n2.__esModule)
            return n2;
          var o = /* @__PURE__ */ Object.create(null);
          if (r.r(o), Object.defineProperty(o, "default", { enumerable: true, value: n2 }), 2 & e2 && "string" != typeof n2)
            for (var t in n2)
              r.d(o, t, function(e3) {
                return n2[e3];
              }.bind(null, t));
        ...
        "use strict";
        r.r(e);
        var o, t = { spell: r(0), stroke: r(1), spellDefault: r(2), info: r(3) }, a = { simple: "simple", trad: "trad", poly: "poly", alltone: "alltone", array: "array" }, i = function(n2) {
          var e2 = t.info.initial;
          n2 = n2.toLowerCase();
          var r2 = o.removeTone(n2, false);
          if (-1 === r2.index) {
            if (!t.spell[r2.spell])
              throw new Error("【spellInfo】错误的拼音: " + n2 + ", 请检查字符是否正确");
            r2.index = parseInt(t.spell[r2.spell][0]) + 1;
          }
          for (var a2 = "", i2 = r2.spell, u2 = 0; u2 < e2.length; u2++)
            if (0 === r2.spell.indexOf(e2[u2])) {
              a2 = e2[u2], i2 = r2.spell.substr(a2.length);
              break;
            }
          return { spell: r2.spell, tone: r2.tone, index: r2.index, initial: a2, final: i2 };
        };
        var u = function() {
          for (var n2 = 0, e2 = 0, r2 = arguments.length; e2 < r2; e2++)
            n2 += arguments[e2].length;
          var o2 = Array(n2), t2 = 0;
          for (e2 = 0; e2 < r2; e2++)
            for (var a2 = arguments[e2], i2 = 0, u2 = a2.length; i2 < u2; i2++, t2++)
              o2[t2] = a2[i2];
          return o2;
        };
        function l() {
        ...
        function f(n2, e2) {
          if (void 0 === e2 && (e2 = 1), !n2 || 0 === n2.length || 0 === e2)
            return [];
          if (e2 >= n2.length)
            return c(Object.assign([], n2));
          for (var r2 = [], o2 = n2.length, t2 = []; t2.length < e2; ) {
            var a2 = p(0, o2 - 1);
            t2.includes(a2) || (t2.push(a2), r2.push(n2[a2]));
          }
          return r2;
        }
        function c(n2) {
          for (var e2, r2, o2 = n2.length; o2; )
            r2 = Math.floor(Math.random() * o2--), e2 = n2[o2], n2[o2] = n2[r2], n2[r2] = e2;
          return n2;
        }
        function p(n2, e2) {
          return n2 + Math.round(Math.random() * (e2 - n2));
        }
        var h = function(n2) {
          var e2;
          return 1 === n2.length ? !!n2.match(/[\u4e00-\u9fa5]/) : (null === (e2 = n2.match(/[\u4e00-\u9fa5]/g)) || void 0 === e2 ? void 0 : e2.join("").length) === n2.length;
        };
        ...
        function x(n2, e2) {
          var r2 = e2[0].split(""), o2 = e2.splice(1);
          E("spell", o2);
          var a2 = d(o2, y.poly), i2 = d(o2, y.tone), u2 = [];
          for (var l2 in n2)
            for (var s2 = n2[l2], f2 = parseInt(s2[0]), c2 = function(n3) {
              var e3 = r2[n3], o3 = function(r3) {
                C(e3, r3) ? u2[n3].unshift(r3) : u2[n3].push(r3);
              };
              if (h(e3)) {
                var c3 = s2.indexOf(e3);
                if (-1 !== c3) {
                  var p3 = T(l2, s2, c3, a2, i2, f2);
                  if (p3.poly) {
                    u2[n3] || (u2[n3] = []), o3(p3.res);
                    for (var d2 = s2, g3 = d2.match(new RegExp(e3, "g")).length, v3 = 1; v3 < g3; v3++)
                      c3 = (d2 = d2.substr(c3 + 2)).indexOf(e3), o3(T(l2, d2, c3, a2, i2, f2).res);
                  } else
                    p3.isPolyWord && t.spellDefault[e3] && (p3.res = S(t.spellDefault[e3], i2).spell), u2[n3] = [p3.res], r2[n3] = "";
                }
              } else
                "" !== e3 && (u2[n3] = ["NOT_CNCHAR", e3]);
          ...
          for (p2 = 0; p2 < r2.length; p2++) {
            var v2 = u2[p2];
            void 0 === v2 ? g2[p2] = r2[p2] : v2.length > 1 ? "NOT_CNCHAR" === v2[0] ? g2[p2] = v2[1] : g2[p2] = "(" + v2.join("|") + ")" : g2[p2] = v2[0], d(o2, y.flat) && d(o2, y.tone) && (g2[p2] = P(g2[p2], true));
          }
          return d(o2, y.array) ? g2 : g2.join("");
        }
        var w = function(n2, e2) {
          g._.poly && k(n2, O), d(e2, y.first) && k(n2, b), d(e2, y.up) ? k(n2, j) : d(e2, y.low) || k(n2, z);
        };
        function k(n2, e2) {
          n2.forEach(function(r2, o2) {
            "string" != typeof r2 ? "NOT_CNCHAR" !== r2[0] && r2.forEach(function(n3, o3) {
              r2[o3] = e2(n3);
            }) : n2[o2] = e2(r2);
          });
        }
        ...
        function T(n2, e2, r2, o2, t2, a2) {
          var i2 = parseInt(e2[r2 + 1]), u2 = { res: n2, poly: false, isPolyWord: i2 >= 5 };
          return o2 || t2 ? (u2.isPolyWord && (i2 -= 5, o2 && (u2.poly = true)), t2 && (u2.res = _(n2, a2, i2)), u2) : u2;
        }
        function C(n2, e2) {
          var r2 = t.spellDefault[n2];
          return !!r2 && (r2 === e2 || P(r2, true).replace(/[0-4]/, "") === e2);
        }
        var S = function(n2, e2) {
          if (e2)
            return { spell: n2 };
          for (var r2 = 0; r2 < n2.length; r2++) {
            var o2 = v.indexOf(n2[r2]);
            if (-1 !== o2)
              return { spell: n2.substr(0, r2) + "aoeiuün"[Math.floor(o2 / 4)] + n2.substr(r2 + 1), tone: o2 % 4 + 1, index: r2 + 1 };
          }
        ...
        function _(n2, e2, r2) {
          if (0 === r2)
            return n2;
          var o2 = n2[e2], t2 = v[4 * "aoeiuün".indexOf(o2) + (r2 - 1)];
          return o2 !== t2 ? n2.replace(o2, t2) : n2;
        }
        function q(n2, e2) {
          var r2 = e2[0].split(""), o2 = [], t2 = e2.splice(1);
          for (var a2 in E("stroke", t2), n2)
            for (var i2 = 0; i2 < r2.length; i2++)
              r2[i2] && -1 !== n2[a2].indexOf(r2[i2]) && (r2[i2] = "", o2[i2] = parseInt(a2));
          return r2.forEach(function(n3, e3) {
            n3 && (o2[e3] = 0);
          }), d(t2, y.array) ? o2 : W(o2);
        }
        var W = function(n2) {
          var e2 = 0;
        ...
        }, A = false, E = function(n2, e2, r2) {
          if (g.check)
            if (A)
              A = false;
            else {
              r2 && (A = true);
              for (var o2 = [], t2 = e2.length - 1; t2 >= 0; t2--) {
                var a2 = e2[t2];
                g.type[n2][a2] || (o2.push(a2), e2.splice(t2, 1));
              }
              ...
              -1 === g.plugins.indexOf("trad") && (d(e2, "simple") && i2.push("simple"), d(e2, "trad") && i2.push("trad")), "spell" === n2 ? d(e2, "up") && d(e2, "low") && i2.push("low") : "stroke" === n2 ? d(e2, "order") ? (l2("array", u2), d(e2, "letter") ? (l2(["detail", "shape", "name", "count"]), l2("letter", u2)) : d(e2, "detail") ? l2(["shape", "name", "count"]) : d(e2, "shape") ? l2(["name", "count"]) : d(e2, "name") && l2(["count"])) : (l2(["detail", "shape", "name", "letter"]), l2("count", u2)) : "orderToWord" === n2 ? d(e2, "match") ? l2(["matchorder", "contain", "start"]) : d(e2, "matchorder") ? l2(["contain", "start"]) : d(e2, "contain") && l2(["start"]) : "strokeToWord" === n2 || "spellToWord" === n2 || "idiom" === n2 && (d(e2, "spell") ? l2(["stroke", "char"]) : d(e2, "stroke") ? l2(["tone", "char"]) : l2(["tone"])), N(o2, "无效", n2, e2), N(i2, "被忽略", n2, e2), N(u2, "冗余", n2, e2);
            }
        };
        function N(n2, e2, r2, o2) {
          if (n2.length > 0) {
            var t2 = "以下参数" + e2 + ":" + JSON.stringify(n2) + ";";
            "被忽略" !== e2 || "stroke" !== r2 || d(o2, "order") ? t2 += " 可选值：[" + Object.keys(g.type[r2]) + "]" : t2 += " 要启用笔顺模式必须使用 order 参数", l(t2);
          }
        }
        function P(n2, e2) {
          void 0 === e2 && (e2 = false);
          ...
          if (r2)
            return n2;
          var o2 = I(n2, false, "low");
          return -1 !== o2.spell.indexOf("ü") && (o2.spell = o2.spell.replace("ü", "v")), r2 ? n2 : o2.spell + o2.tone;
        }
        var I = function(n2, e2, r2) {
          void 0 === e2 && (e2 = false), void 0 === r2 && (r2 = "low"), -1 !== n2.indexOf("v") && (n2 = n2.replace("v", "ü"));
          var o2, t2, a2 = n2[n2.length - 1], u2 = -1, l2 = false;
          parseInt(a2).toString() === a2 ? (n2 = n2.substr(0, n2.length - 1), u2 = (t2 = i(n2)).index, o2 = parseInt(a2), l2 = true, e2 && (n2 = _(n2, u2 - 1, o2))) : (u2 = (t2 = i(n2)).index, o2 = t2.tone, e2 || 0 === o2 || (n2 = t2.spell));
          return "low" === r2 ? n2 = n2.toLowerCase() : "up" === r2 && (n2 = n2.toUpperCase()), { spell: n2, tone: o2, index: u2, isTrans: l2 };
        };
        var R = function(n2) {
          var e2 = n2.target, r2 = n2.key, o2 = n2.value, t2 = n2.isSpell, a2 = void 0 !== t2 && t2;
          s(r2, o2, function(n3, r3) {
            n3 && r3 && (e2[n3] = a2 ? P(r3) : r3);
          });
        };
        function M(n2, e2, r2, o2, a2) {
          if (void 0 === a2 && (a2 = false), "object" != typeof r2)
            if (o2 instanceof Array)
              ...
              var f2 = "" + r2 + (i2.tone + (a2 ? 5 : 0));
              if (n2[i2.spell] = u2 ? u2 + f2 : i2.index + ":" + f2, 1 === e2.length) {
                var c2 = e2[0];
                n2[c2.spell] = n2[c2.spell].replace("" + r2 + c2.tone, "" + r2 + (c2.tone + 5));
              }
              a2 && function(n3) {
                -1 === t.info.polyWord.indexOf(n3) && (t.info.polyWord += n3);
              }(r2);
            }
          else
            for (var p2 in r2)
        ...
        function D(n2, e2) {
          var r2 = x(n2, [e2, y.tone, y.poly]);
          return r2 === e2 ? [] : (-1 !== r2.indexOf("|") ? r2.substring(1, r2.length - 1).split("|") : [r2]).map(function(n3) {
            return I(n3);
          });
        }
        ...
        function U(n2) {
          ...
          J.checkArgs("strokeToWord", e2);
          var o2 = "", a2 = { simple: J.has(e2, H.simple), trad: J.has(e2, H.trad) };
          return a2.simple || a2.trad || (a2.simple = a2.trad = true), a2.simple && (o2 += B(n2, t.stroke)), a2.trad && J.dict.getTradCount && (o2 += B(n2, J.dict.getTradCount())), J.has(e2, H.array) ? o2.split("") : o2;
        }
        function B(n2, e2) {
        ...
        function K(n2) {
          Y = n2, function(n3) {
            L = n3, "aoeiuvn".split("").forEach(function(n4) {
              for (var e2 = n4.charCodeAt(0), r2 = 1; r2 <= 4; r2++)
                F.push(e2 + 0.1 * r2);
            });
          }(n2);
        }
        ...
        function en(n2, e2) {
          var r2 = ["low"];
          if (e2 && r2.push("tone"), Y.isCnChar(n2))
            return Y.spell.apply(Y, Z([n2], r2));
          try {
            return Y._.transformTone(n2, e2).spell;
          } catch (n3) {
            return console.warn(n3.message), "";
          }
        }
        function rn(n2, e2, r2) {
          ...
          for (var o2 = 0; o2 < n2.length; o2++) {
            if (!e2[o2])
              return Q;
            var t2 = X(n2[o2], r2), a2 = X(e2[o2], r2);
            if (t2 > a2)
              return Q;
            if (t2 < a2)
              return V;
          }
          return n2.length === e2.length ? nn : V;
        }
        function on(n2, e2) {
          return "string" == typeof n2 && (n2 = Y.stroke(n2)), "string" == typeof e2 && (e2 = Y.stroke(e2)), n2 > e2 ? Q : n2 < e2 ? V : nn;
        }
        var tn = function(n2) {
          var e2 = function() {
            l("请先调用 cnchar-" + n2);
          };
          return e2.__default = true, e2;
        }, an = [];
        function un(n2) {
          return -1 === an.indexOf(n2) && (an.push(n2), true);
        }
        var ln = "";
        var sn = "object" == typeof wx && "object" == typeof __wxConfig ? "miniapp" : "object" == typeof window ? "web" : "node", fn = function() {
          return (fn = Object.assign || function(n2) {
            for (var e2, r2 = 1, o2 = arguments.length; r2 < o2; r2++)
              for (var t2 in e2 = arguments[r2])
                Object.prototype.hasOwnProperty.call(e2, t2) && (n2[t2] = e2[t2]);
            return n2;
        ...
        var dn, gn, vn, yn, mn, xn = fn(fn({ env: sn, version: "3.2.4", spell: pn, stroke: hn, check: true, _origin: { spell: pn, stroke: hn }, plugins: an, hasPlugin: function(n2) {
          ...
          n2.forEach(function(n3) {
            var e3 = n3.pluginName, o2 = n3.install, t2 = n3.args;
            if (e3) {
              if (un(e3)) {
                var a2 = r2;
                t2 && (a2.type[e3] = t2), n3.getCnChar = function() {
                  return r2;
                }, n3.installed = true, a2[e3] = n3, o2 && o2(r2);
              }
            } else
        ...
        }, tones: v, setIntoJson: R, _warn: l, dealUpLowFirst: w, removeTone: S, sumStroke: W, isCnChar: h, checkArgs: E, transformTone: I, dict: {}, mapJson: s, checkTrad: function(n2, e2) {
          if (-1 === e2.indexOf("trad") || -1 === g.plugins.indexOf("trad"))
            return n2;
          var r2 = false;
          return n2 instanceof Array && (r2 = true, n2 = n2.join("")), n2 = g.convert.tradToSimple(n2), r2 ? n2.split("") : n2;
        }, getResourceBase: function() {
          return ln;
        }, pickRandomEle: f, shuffle: c, randomNum: p, pickRandomChar: function(n2, e2) {
          return void 0 === e2 && (e2 = 1), n2 ? f(n2.split(""), e2).join("") : "";
        } }, type: { spell: y, stroke: { array: y.array } }, transformTone: I, isCnChar: h, compareSpell: rn, compareStroke: on, sortSpell: function(n2) {
          for (var e2 = [], r2 = 1; r2 < arguments.length; r2++)
            e2[r2 - 1] = arguments[r2];
          var o2 = false;
          "string" == typeof n2 && (n2 = n2.split(""), o2 = true);
          var t2 = -1 !== e2.indexOf($), a2 = -1 !== e2.indexOf(G), i2 = a2 ? -1 : 1, u2 = -1 * i2, l2 = n2.sort(function(n3, e3) {
            var r3 = rn(n3, e3, t2);
            return r3 === Q ? i2 : r3 === V ? u2 : 0;
          });
          return o2 ? l2.join("") : l2;
        }, sortStroke: function(n2, e2) {
          var r2 = false;
          "string" == typeof n2 && (n2 = n2.split(""), r2 = true);
          var o2 = e2 === G ? -1 : 1, t2 = -1 * o2, a2 = n2.sort(function(n3, e3) {
            var r3 = on(n3, e3);
            return r3 === Q ? o2 : r3 === V ? t2 : 0;
          });
          return r2 ? a2.join("") : a2;
        }, setSpellDefault: function(n2, e2) {
          R({ target: t.spellDefault, key: n2, value: e2, isSpell: true });
        }, setSpell: function(n2, e2) {
          !function(n3, e3, r2) {
            var o2;
            if ("object" == typeof e3)
              for (var t2 in o2 = {}, e3)
        ...
        }, setStrokeCount: function(n2, e2) {
          var r2 = t.stroke;
          s(n2, e2, function(n3, o2) {
            var t2 = q(r2, [n3]);
            if (t2 !== e2) {
              if (0 !== t2) {
                var a2 = t2.toString();
              ...
              r2[o2] ? r2[o2] += n3 : r2[o2] = n3;
            }
          });
        }, isPolyWord: function(n2) {
          return "" !== n2 && (n2.length > 1 && (n2 = n2[0]), !!h(n2) && -1 !== t.info.polyWord.indexOf(n2));
          ...
          var i2 = o.transformTone(r2, false), u2 = n2.splice(1);
          o.checkArgs("spellToWord", u2);
          var l2 = { simple: o.has(u2, a.simple), trad: o.has(u2, a.trad), poly: o.has(u2, a.poly), alltone: o.has(u2, a.alltone) };
          l2.simple || l2.trad || (l2.simple = l2.trad = true);
          for (var s2 = "", f2 = t.spell[i2.spell].substr(2), c2 = 0; c2 < f2.length; c2 += 2) {
            var p2 = f2[c2], h2 = parseInt(f2[c2 + 1]), d2 = h2 > 4;
            d2 && (h2 -= 5), -1 !== s2.indexOf(p2) || !l2.alltone && h2 !== i2.tone || l2.poly && !d2 || (s2 += p2);
          }
          if (l2.trad && o.convert) {
            var g2 = "";
            for (c2 = 0; c2 < s2.length; c2++) {
              var v2 = o.convert.simpleToTrad(s2[c2]);
              v2 !== s2[c2] && (g2 += v2);
            }
            l2.simple ? s2 += g2 : s2 = g2;
          }
          return o.has(u2, a.array) ? s2.split("") : s2;
        }, strokeToWord: U, spellInfo: i, setResourceBase: function(n2) {
          var e2 = this;
          ln = n2, this.plugins.forEach(function(n3) {
            var r2, o2 = e2[n3];
            o2 && (null === (r2 = o2._refreshResource) || void 0 === r2 || r2.call(o2, e2));
          });
          ...
          return tn("radical"), "";
        } }, trad: tn("trad"), order: tn("order"), xhy: yn, words: tn("words"), explain: tn("explain"), voice: tn("voice"), code: tn("code"), input: tn("input"), random: tn("random"), info: tn("info"), poly: tn("poly"), name: tn("name") })), { pluginName: "cnchar", dict: t });
        ...
        }, g = xn, o = (mn = xn)._, i.tones = o.tones.split(""), i.initials = t.info.initial, mn.spellInfo = i, mn.type.spellToWord = a, function(n2) {
...
export default require_cnchar_min();
//# sourceMappingURL=cnchar.js.map
