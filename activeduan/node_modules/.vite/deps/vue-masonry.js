...
// node_modules/vue-masonry/node_modules/vue-demi/lib/index.mjs
var isVue2 = false;
var Vue2 = void 0;
...
var numberOrSelector = function(val) {
  return isNaN(val) ? val : parseInt(val);
};
var collectOptions = function(attrs) {
  const res = {};
...
var VueMasonryPlugin = {};
VueMasonryPlugin.install = function(app, options) {
  const Events = isVue2 ? new Vue2() : mitt_default();
  ...
  appOrVue2.directive("masonry", {
    ...
    [isVue2 ? "inserted" : "mounted"]: function(el, binding) {
      if (!import_masonry_layout.default) {
        throw new Error("Masonry plugin is not defined. Please check it's connected and parsed correctly.");
      }
      const options2 = collectOptions(el.attributes);
      const masonry = new import_masonry_layout.default(el, options2);
      const masonryId = binding.value || defaultId;
      const destroyDelay = options2["destroyDelay"] ? parseInt(options2["destroyDelay"], 10) : void 0;
  ...
  appOrVue2.directive("masonryTile", {
    [isVue2 ? "inserted" : "mounted"]: function(el, binding) {
      ...
      new import_imagesloaded.default(el, function() {
...
imagesloaded/imagesloaded.js:
   ...
   *)
*/
//# sourceMappingURL=vue-masonry.js.map
